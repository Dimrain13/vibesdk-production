...
interface BaseAgentInitArgs {
    ...
    // Classification info from RequestClassifier
    classificationType?: 'conversation' | 'build_vague' | 'build_clear';
    classificationResponse?: string; // For conversation type
    clarificationQuestion?: string; // For build_vague type
}
